		...
		{(view === 'create' || view === 'edit') && (
		  <div className="max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
			<div className="bg-[#111] rounded-[3rem] border border-white/5 p-10 md:p-16 shadow-2xl">
			  ...
			  {/* ── GRID DE DOS COLUMNAS: FORMULARIO + PREVIEW ── */}
			  <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
				...
				<div className="lg:col-span-2">
				  <form onSubmit={handleUpdateProduct} className="space-y-8">
					...
					{/* ── Nombre ── */}
					<div>
					  <label className="block text-xs font-bold text-gray-500 uppercase mb-3 tracking-wider">Nombre del producto</label>
					...
					{/* ── URL original ── */}
					<div>
					  <label className="block text-xs font-bold text-gray-500 uppercase mb-3 tracking-wider">URL del producto</label>
					...
					{/* ── Resto de campos (Categoría, Tallas, etc.) ── */}
					{/* ... (Aquí mantienes tu lógica existente de Categoría, Tallas y Personalización) ... */}
					{/* (Para no extender el mensaje demasiado, asegúrate de mantener tus bloques de Categoría, Tallas, Personalización y Finanzas tal cual los tenías en tu código original aquí abajo) */}

					{/* ── Finanzas (Costo + Venta + Stock) ── */}
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					  <div>
						<label className="block text-xs font-bold text-gray-500 uppercase mb-3 tracking-wider">Precio de Costo</label>
						<input type="text" required value={newProduct.price_original}
					  ...
					  <div>
						...
						<input type="number" required value={newProduct.price_custom}
					  ...
					  <div>
						<label className="block text-xs font-bold text-gray-500 uppercase mb-3 tracking-wider">Stock</label>
						<input type="number" min="0" required value={newProduct.stock_quantity}
					...
					{/* ── Submit ── */}
					<button type="submit" className="w-full bg-emerald-500 text-black font-black py-5 rounded-2xl hover:bg-emerald-400 transition-all text-sm uppercase tracking-widest">
				...
				<div className="lg:col-span-1">
				  <ProductPreview 
					data={{
					  name: newProduct.name,
					  price: newProduct.price_custom,
					  image_url: imagePreviews[0] // Muestra la primera imagen subida
					}} 
				  />
				</div>
